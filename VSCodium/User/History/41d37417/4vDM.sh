...
sudo pacman -S yay libreoffice-fresh kdenlive vscodium flatpak discover obs-studio plasma steam intellij-idea-community-edition arduino-ide

# Step 3: Install multimedia codecs for compatibility with various file types
sudo pacman -S gst-libav gst-plugins-good gst-plugins-bad gst-plugins-ugly

# Step 4: Install gaming optimization tools
...
echo "Installation complete! Rebooting system to apply updates and changes."
sudo reboot
